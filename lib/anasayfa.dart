...
import 'package:json_parse_kullanimi/filmler_cevap.dart';
...
class _AnasayfaState extends State<Anasayfa> {
  ...
  void kisilerParse(){
    ...
    String veri = '{"kisiler":[{"kisi_id":"12819","kisi_ad":"Ahmet","kisi_tel":"0000"},{"kisi_id":"12821","kisi_ad":"Zeynep","kisi_tel":"9999"}],"success":1}';
    var jsonVeri = json.decode(veri);
  ...
  void filmlerParse(){
    ...
    for(var f in filmlerCevap.filmler){
      ...
      print("film yış: ${f.film_yil}");
      print("film rsim: ${f.film_resim}");
